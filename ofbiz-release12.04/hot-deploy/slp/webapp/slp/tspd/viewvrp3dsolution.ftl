<!-- DataTables CSS -->
<link href="/resource/slp/css/dataTables.bootstrap.css" rel="stylesheet">

<!-- DataTables Responsive CSS -->
<link href="/resource/slp/css/dataTables.responsive.css" rel="stylesheet">

<!-- DataTables JavaScript -->
<script src="/resource/slp/js/jquery.dataTables.js"/>"></script>
<script src="/resource/slp/js/dataTables.bootstrap.js"></script>
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDiwen191NaCB_987eRnkOlAwTEfrYReCE"></script>

<script src="/resource/slp/js/processing.js"/>"></script>
...
$(document).ready(function() {
    $.ajax({
		url: "/slp/control/compute-vrp3d-solution",
		type: 'post',
	    dataType: "json",
		contentType: 'application/json; charset=utf-8',
		success: function (data) {
			dataResponse=data.sol;
			routes = dataResponse.routes;
			loads = dataResponse.loads;
			initMap();
		}
	});
});
