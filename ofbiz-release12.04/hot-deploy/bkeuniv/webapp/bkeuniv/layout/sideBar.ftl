...
<@SideBar open=true handleToggle="sideBar" width="300px">
	<@List height="100%" width="300px">
		<@ListItem id="home-112101" primaryText=uiLabelMap.BkEunivHomePage leftIcon="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z" linkTo="main" />
		<@ListItem id="user-991011" primaryText=uiLabelMap.BkEunivPersonalInformation linkTo="main"leftIcon="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" linkTo="user"/>
