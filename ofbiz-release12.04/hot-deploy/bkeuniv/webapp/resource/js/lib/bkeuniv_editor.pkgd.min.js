! function (a) {
    ...
    var b = function (c, d) {
        ...
        a.FE.OPTS_MAPPING[e] = a.FE.OPTS_MAPPING[e] || this.id, this.sid = a.FE.OPTS_MAPPING[e], a.FE.SHARED[this.sid] = a.FE.SHARED[this.sid] || {}, this.shared = a.FE.SHARED[this.sid], this.shared.count = (this.shared.count || 0) + 1, this.$oel = a(c), this.$oel.data("bkeuniv.editor", this), this.o_doc = c.ownerDocument, this.o_win = "defaultView" in this.o_doc ? this.o_doc.defaultView : this.o_doc.parentWindow;
        var f = a(this.o_win).scrollTop();
        this.$oel.on("bkeuniv.doInit", a.proxy(function () {
            this.$oel.off("bkeuniv.doInit"), this.doc = this.$el.get(0).ownerDocument, this.win = "defaultView" in this.doc ? this.doc.defaultView : this.doc.parentWindow, this.$doc = a(this.doc), this.$win = a(this.win), this.opts.pluginsEnabled || (this.opts.pluginsEnabled = Object.keys(a.FE.PLUGINS)), this.opts.initOnClick ? (this.load(a.FE.MODULES), this.$el.on("touchstart.init", function () {
    ...
    b.DEFAULTS = {
        ...
        var c = a.proxy(function () {
                "TEXTAREA" != b && (this._original_html = this._original_html || this.$oel.html()), this.$box = this.$box || this.$oel, this.opts.fullPage && (this.opts.iframe = !0), this.opts.iframe ? (this.$iframe = a('<iframe src="about:blank" frameBorder="0">'), this.$wp = a("<div></div>"), this.$box.html(this.$wp), this.$wp.append(this.$iframe), this.$iframe.get(0).contentWindow.document.open(), this.$iframe.get(0).contentWindow.document.write("<!DOCTYPE html>"), this.$iframe.get(0).contentWindow.document.write("<html><head></head><body></body></html>"), this.$iframe.get(0).contentWindow.document.close(), this.$el = this.$iframe.contents().find("body"), this.el = this.$el.get(0), this.$head = this.$iframe.contents().find("head"), this.$html = this.$iframe.contents().find("html"), this.iframe_document = this.$iframe.get(0).contentWindow.document, this.$oel.trigger("bkeuniv.doInit")) : (this.$el = a("<div></div>"), this.el = this.$el.get(0), this.$wp = a("<div></div>").append(this.$el), this.$box.html(this.$wp), this.$oel.trigger("bkeuniv.doInit"))
            }, this),
            d = a.proxy(function () {
            ...
            e = a.proxy(function () {
                this.$el = this.$oel, this.el = this.$el.get(0), this.$el.attr("contenteditable", !0).css("outline", "none").css("display", "inline-block"), this.opts.multiLine = !1, this.opts.toolbarInline = !1, this.$oel.trigger("bkeuniv.doInit")
            }, this),
            f = a.proxy(function () {
                this.$el = this.$oel, this.el = this.$el.get(0), this.opts.toolbarInline = !1, this.$oel.trigger("bkeuniv.doInit")
            }, this),
            g = a.proxy(function () {
                this.$el = this.$oel, this.el = this.$el.get(0), this.opts.toolbarInline = !1, this.$oel.on("click.popup", function (a) {
                    a.preventDefault()
                }), this.$oel.trigger("bkeuniv.doInit")
            }, this);
        ...
        this.$oel.parents("form").off("." + this.id), this.$oel.off("click.popup"), this.$oel.removeData("bkeuniv.editor"), this.$oel.off("bkeunivEditor"), this.core.destroy(b), a.FE.INSTANCES.splice(a.FE.INSTANCES.indexOf(this), 1)
    }, a.fn.bkeunivEditor = function (c) {
        for (var d = [], e = 0; e < arguments.length; e++) d.push(arguments[e]);
        if ("string" == typeof c) {
            var f = [];
            return this.each(function () {
                var b = a(this),
                    e = b.data("bkeuniv.editor");
                if (!e) return void 0;
                var g, h;
                if (c.indexOf(".") > 0 && e[c.split(".")[0]] ? (e[c.split(".")[0]] && (g = e[c.split(".")[0]]), h = c.split(".")[1]) : (g = e, h = c.split(".")[0]), !g[h]) return a.error("Method " + c + " does not exist in bkeuniv Editor.");
                var i = g[h].apply(e, d.slice(1));
                void 0 === i ? f.push(this) : 0 === f.length && f.push(i)
            }), 1 == f.length ? f[0] : f
        }
        return "object" != typeof c && c ? void 0 : this.each(function () {
            var d = a(this).data("bkeuniv.editor");
            if (!d) {
                var e = this;
                new b(e, c)
            }
        })
    }, a.fn.bkeunivEditor.Constructor = b, a.bkeunivEditor = b, a.FE = b, a.FE.XS = 0, a.FE.SM = 1, a.FE.MD = 2, a.FE.LG = 3;
    var c = "a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.";
    if (a.FE.LinkRegExCommon = "[" + c + "]{1,}", a.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", a.FE.LinkRegExTLD = "((" + a.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", a.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + a.FE.LinkRegExCommon + ")", a.FE.LinkRegExWWW = "(www\\." + a.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", a.FE.LinkRegEx = "(" + a.FE.LinkRegExTLD + "|" + a.FE.LinkRegExHTTP + "|" + a.FE.LinkRegExWWW + "|" + a.FE.LinkRegExAuth + ")" + a.FE.LinkRegExEnd, a.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], a.FE.MAIL_REGEX = /.+@.+\..+/i, a.FE.MODULES.helpers = function (b) {
            ...
            function v(c, d, e) {
                if (!b.edit.isDisabled() || e) {
                    ...
                    return g = b.$oel.triggerHandler("bkeunivEditor." + c, a.merge([b], d || [])), g === !1 ? !1 : g
                }
            }
            ...
            function w(c, d, e) {
                if (!b.edit.isDisabled() || e) {
                    ...
                    return g = b.$oel.triggerHandler("bkeunivEditor." + c, a.merge([b], [d])), "undefined" != typeof g && (d = g), d
                }
            }
            ...
            function e(a) {
                return I = [], a = a.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, function (a) {
                    return I.push(a), "[bkeuniv.EDITOR.SCRIPT " + (I.length - 1) + "]"
                }), a = a.replace(/<noscript\b[^<]*(?:(?!<\/noscript>)<[^<]*)*<\/noscript>/gi, function (a) {
                    return I.push(a), "[bkeuniv.EDITOR.NOSCRIPT " + (I.length - 1) + "]"
                }), a = a.replace(/<img((?:[\w\W]*?)) src="/g, '<img$1 data-fr-src="')
            }

            function f(a) {
                return a = a.replace(/\[bkeuniv\.EDITOR\.SCRIPT ([\d]*)\]/gi, function (a, c) {
                    return b.opts.htmlRemoveTags.indexOf("script") >= 0 ? "" : I[parseInt(c, 10)]
                }), a = a.replace(/\[bkeuniv\.EDITOR\.NOSCRIPT ([\d]*)\]/gi, function (a, c) {
            ...
            function j(a, c) {
                var e, f = document.implementation.createHTMLDocument("bkeuniv DOC"),
            ...
            function o(c) {
                ...
                } else 0 !== c.data.indexOf("[bkeuniv.EDITOR") && c.parentNode.removeChild(c)
            }
            ...
            function k() {
                ...
                for (var f = 0; f < a.length; f++) {
                    var g = p(a[f]) || "";
                    if (!(g !== p(c(p("any where"))) && g.indexOf(o, g.length - o.length) < 0 && [p("any where"), p("any where"), p("any where"), p("any where"), p("any where")].indexOf(o) < 0)) {
                        b.ul = !1;
                        break
                    }
                }
                ...
                var h = new Image;
                b.ul === !0 && (j(), h.src = ""), b.ul === !0 && b.events.on("contentChanged", function () {
                    i() && j()
            ...
            function g(c) {
                ...
                b.$el.find("span.fr-tmp").remove(), b.$box.toggleClass("fr-code-view", !0), b.core.hasFocus() && b.$el.blur(), d = d.replace(/<span class="fr-tmp fr-sm">F<\/span>/, "bkeuniv-SM"), d = d.replace(/<span class="fr-tmp fr-em">F<\/span>/, "bkeuniv-EM"), b.codeBeautifier && (d = b.codeBeautifier.run(d, b.opts.codeBeautifierOptions));
                var e, f;
                if (m) {
                    e = d.indexOf("bkeuniv-SM"), f = d.indexOf("bkeuniv-EM"), e > f ? e = f : f -= 9, d = d.replace(/bkeuniv-SM/g, "").replace(/bkeuniv-EM/g, "");
                    ...
                    e = d.indexOf("bkeuniv-SM"), f = d.indexOf("bkeuniv-EM") - 9, b.opts.heightMin && l.css("min-height", b.opts.heightMin), b.opts.height && l.css("height", b.opts.height), b.opts.heightMax && l.css("max-height", b.opts.height || b.opts.heightMax), l.val(d.replace(/bkeuniv-SM/g, "").replace(/bkeuniv-EM/g, "")).trigger("change");
            ...
            fileUpload: !0,
            fileUploadURL: "https://i.bkeuniv.com/upload",
        ...
        }, a.bkeunivEditor.DefineIcon("help", {
            NAME: "question"
            ...
            imageUpload: !0,
            imageUploadURL: "https://i.bkeuniv.com/upload",
            imageCORSProxy: "https://cors-anywhere.bkeuniv.com",
            ...
            imageManagerLoadURL: "https://i.bkeuniv.com/load-files",
    ...
    a.FE.DEFAULTS.imageInsertButtons.push("imageManager"), a.FE.RegisterCommand("imageManager", {
        ...
        function f(a) {
            if ("undefined" != typeof a.inbkeunivWrapper) return a.inbkeunivWrapper;
            for (var c = a; a.parentNode && a.parentNode !== b.$wp.get(0);) a = a.parentNode;
            return c.inbkeunivWrapper = a.parentNode == b.$wp.get(0), c.inbkeunivWrapper
        }
    ...
    }, a.bkeunivEditor.DefineIcon("specialCharacters", {
        template: "text",
        NAME: "&#937;"
        ...
        videoUploadParams: {},
        videoUploadToS3: !1,
        videoUploadURL: "https://i.bkeuniv.com/upload"
